...
const en = {
  ...
  ecosystem: {
    ...
    description:
      "Desktop, Mobile and Server speak the same language: the open v5 protocol. Join the same server from your PC or phone, share your screen from either one, and host everything on your own infrastructure.",
    ...
    protocolTitle: "Open protocol v5",
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        title: "Add-ons",
        description:
          ".halla-addon packs with a public C ABI shared between Desktop and Mobile: PCM audio hooks, radio effect and v5 data transport.",
      },
      {
      ...
      },
      {
        title: "Open protocol",
        description:
          "Publicly documented v5 specification for implementing clients, bots and tools. TCP/TLS control with JSON and encrypted UDP voice.",
      },
    ],
  },
  gallery: {
  ...
  security: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Opus audio and transmissions encrypted with ChaCha20-Poly1305 (AEAD) using a 32-byte per-channel key. The server is a pure relay: it forwards packets, but never holds the key to decrypt them.",
      },
      {
        title: "Key rotation",
        description:
          "Whenever a channel's membership changes — someone joins, leaves or is moved — the component key is rotated and redistributed. Basic forward secrecy built into the protocol, with no effort from the user.",
      },
      {
